...
summary.cumulcalib <- function(x, method=NULL, ...)
{
  if(is.null(method))
  {
    method <- x$method
  ...
  n <- dim(x$data)[1]
  print(paste("C_n (mean calibration error):",x$C_n))
  print(paste("C* (maximum absolute cumulative calibration error):",x$C_star))

  if(method=="BM")
  {
    print("Method: One-part Brownian Motion (BM)")
    print(paste("S* (test statistic for cumulative calibration error):",x$S_star))
    print(paste("P-value:",x$by_method$BM$pval))
    print(paste("Location of maximum drift:",x$by_method$BM$loc,
                " | time value:", x$data[x$by_method$BM$loc,'t'],
                " | predictor value:", x$data[x$by_method$BM$loc,'X']))
  }
  if(method=="BM2p")
  {
    print("Method: Two-part Brownian Motion (BM2p)")
    print(paste("S_n (Z score for mean calibration error)",x$S_n))
    print(paste("S* (test statistic for cumulative calibration error):",x$S_star))
    print(x$by_method$BM2p$stat_by_component)
    print("Component-wise p-values:")
    print(x$by_method$BM2p$pval_by_component)
    print(paste("Combined value (Fisher'smethod):",x$by_method$BM2p$pval))
    print(paste("Location of maximum drift:",x$by_method$BM2p$loc,
                " | time value:", x$data[x$by_method$BM2p$loc,'t'],
                " | predictor value:", x$data[x$by_method$BM2p$loc,'X']))
  }
  if(method=="BB1p")
  {
    print("Method: One-part Brownian Bridge (BB1p)")
    print(paste("B* (test statistic for maximum absolute bridged calibration error):",x$B_star))
    print(paste("Test statistic value:",x$by_method$BB1p$stat))
    print(paste("P-value:",x$by_method$BB1p$pval))
    print(paste("Location of maximum drift:",x$by_method$BB1p$loc,
                " | time value:", x$data[x$by_method$BB1p$loc,'t'],
                " | predictor value:", x$data[x$by_method$BB1p$loc,'X']))
  }
  if(method=="BB")
  {
    ...
    print(paste("B* (test statistic for maximum absolute bridged calibration error):",x$B_star))
    print("Component-wise p-values:")
    print(x$by_method$BB$pval_by_component)
    print(paste("Combined value (Fisher'smethod):",x$by_method$BB$pval))
    print(paste("Location of maximum drift:",x$by_method$BB$loc,
                " | time value:", x$data[x$by_method$BB$loc,'t'],
                " | predictor value:", x$data[x$by_method$BB$loc,'X']))
  }
}
